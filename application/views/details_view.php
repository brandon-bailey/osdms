...
<?php endif;?>
    ...
    <li><a href="<?php echo $fileDetail->editLink; ?>">Edit File Details</a></li>
	   <?php if($fileDetail->deleteLink !== 0):?> <li><a href="#" id="delete">Delete</a></li><?php endif;?>
...
<div class="col-md-6">
<div class="well">
<center><h4>File Details</h4></center>
<table class="table table-striped">
    <tr>
        ...
        <td align="left">
            <font size="+1"><?php echo $fileDetail->realName ?></font>
        </td>
    </tr> 
    <tr>
        <th valign=top align=right>Category:</th><td><?php echo $fileDetail->category?></td>
    </tr>	
	    <tr>
        <th valign=top align=right>Size:</th><td><?php echo $fileDetail->fileSize ?></td>
    </tr>
       <tr>
        <th valign=top align=right>Created Date:</th><td><?php echo $fileDetail->created?></td>
    </tr>
    ...
    <tr>
        ...
        <td>
            <a href="mailto:<?php echo $fileDetail->ownerEmail ?>"> <?php echo $fileDetail->owner ?></a>
        </td>
    </tr>
	
    <tr>
        <th valign=top align=right>Description:</th><td> <?php echo $fileDetail->description;?></td>
    </tr>
	
    <tr>
	<th valign=top align=right>Comment:</th><td> <?php echo $fileDetail->comment?></td>
    </tr>
	
    <tr>
        <th valign=top align=right>Revision: </th><td> <div id="details_revision"><?php echo $fileDetail->revision?></div></td>
    </tr>
		
<?php if($fileDetail->fileUnderReview):?>
    <tr>
        <th valign=top align=right>Reviewer:</th>
        <td> <?php echo $fileDetail->reviewer ?> (<a href="#">Comments</a>)</td>
    </tr>
<?php endif;?>
...
<?php if($fileDetail->status > 0):?>
    <tr>
		<th valign=top align=right>Checked out to:</th>
			<td>
				<a href="mailto:<?php echo $checkoutPersonEmail ?>"> <?php echo $checkoutPersonFullName[1]?>, <?php echo $checkoutPersonFullName[0]?></a></td>
    </tr>
<?php endif;?>
...
<table id="fileTable" class="table table-striped table-condensed">
	...
	<tr>
			<td><font size="-1"><?php echo $item->revision?></font></td>
            <td><font size="-1"><?php echo $item->modifiedOn?></font></td>
            <td><font size="-1"><?php echo $item->firstName?> <?php echo $item->lastName?></font></td>
            <td><font size="-1"><?php echo $item->note?></font></td>
     </tr>
		<?php		
		endforeach;
			endif;
...
$(document).ready(function() {
	...
	$(document).on( "click", 'a#thumbnail' ,function() {
		...
		function(){
				...
				type: "POST",	
				cache:false,			
				data:  ({id: '<?php echo $this->requestId ?>'}),
				success: function(){
