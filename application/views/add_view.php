...
<?php endforeach;?>
       ...
       <label for="userfile">
	   <a class="body" tabindex="1" href="#"  data-toggle="popover" title="File Location" 
 data-content='<p>  This box allows you to browse your local computer to find a file. Click 
   ...
   <div class="col-md-4 col-xs-12 col-sm-6">
           <label for="file_owner"> Assign to Owner</label>       
            ...
            <?php foreach($addDocumentData->availUsers as $user):?>
                <option value="<?php echo $user->id ?>" <?php echo $user->selected ?>><?php echo $user->last_name .','. $user->first_name ?></option>
		<?php endforeach;?>
            </select>
      </div>
	</div>  
        ...
        <div class="form-group">
		   <div class="col-md-4 col-xs-12 col-sm-6">
        <label for="category"> <a class="body" href="#"  data-toggle="popover" title="Category" 
 data-content='<p>
...
on this field.</p>'>Category</a></label>
	...
	<div class="well" style="background-color:#fff;">
		<div id="departmentSelect">
            ...
            <a class="body" href="#" style="text-decoration:none" data-toggle="popover" title="Add Permissions" 
 data-content='<p>This box allows you to define a specific type of access for departments.</p>'>Permissions</a>			
<div class="tabbable" id="tabs-690341">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="department_permission[<?php echo $dept->id?>]" value="-1"></td>
                    <td><input type="radio" name="department_permission[<?php echo $dept->id?>]" value="0"<?php echo $noneselected;?>></td>
                    <td><input type="radio" name="department_permission[<?php echo $dept->id?>]" value="1"<?php echo $selected;?> ></td>
                    <td><input type="radio" name="department_permission[<?php echo $dept->id?>]" value="2"></td>
                    <td><input type="radio" name="department_permission[<?php echo $dept->id?>]" value="3" ></td>
                    <td><input type="radio" name="department_permission[<?php echo $dept->id?>]" value="4"></td>
                </tr>
                <?php endforeach;?>      
            </tbody>
        </table>
...
?>
                <tr>
                    ...
                    <td><input type="radio" name="user_permission[<?php echo $user->id;?>]" value="-1"></td>
                    <td><input type="radio" name="user_permission[<?php echo $user->id;?>]" value="1"></td>
                    <td><input type="radio" name="user_permission[<?php echo $user->id;?>]" value="2"></td>
                    <td><input type="radio" name="user_permission[<?php echo $user->id;?>]" value="3"></td>
                    <td><input type="radio" name="user_permission[<?php echo $user->id;?>]" value="4" <?php echo $user->selected ?>></td>
                </tr>
  ...
  <div class="form-group">
		  ...
		  <a class="body" href="#" data-toggle="popover" title="Description" 
 data-content='<p>This field serves as a short description for the file. 
 ...
 Description</a></label>
	   ...
	   placeholder="ie... Weekly Sales Report">
       </div>
    
  <div class="form-group">
          <label for="comment">
		  <a class="body" href="#" data-toggle="popover" title="Comments" 
 data-content='<p>No one knows this file as good as you do.
...
Comments</a></label>
	   ...
	   class="form-control" placeholder="To view this file, you must download..."></textarea>
       </div>
	   
<div class="form-group text-center">
        <button class="btn btn-primary" type="submit" 
		id="addDocumentsForm"	title="Add Document">
