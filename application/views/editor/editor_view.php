...
.cke_editable.cke_editable_inline.cke_focus
{
    ...
    <header class="navbar navbar-inverse navbar-fixed-top" ><!--Begin Navbar-->
		...
		<div class="navbar-header">
          ...
          <a class="navbar-brand" rel="home" href="<?php echo base_url(); ?>index.php/home" style="margin-top: -7px;" title="Document Management System"><img alt="Document Management System" src="<?php echo base_url(); ?>assets/images/logo-32.png"></a>  
		</div>		         
...
<li><a href="<?php echo base_url(); ?>index.php/profile">
