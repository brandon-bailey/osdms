<div class="tabbable" id="tabs-690341">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="radio" name="user_permission[<?php $user->id?>]" value="1" <?php if ($user->rights == '1'): ?>checked="checked"<?php endif;?>/></td>
                    <td><input type="radio" name="user_permission[<?php $user->id?>]" value="2" <?phpif ($user->rights == '2'): ?>checked="checked"<?php endif;?> /></td>
                    <td><input type="radio" name="user_permission[<?php $user->id?>]" value="3" <?phpif ($user->rights == '3'): ?>checked="checked"<?php endif;?> /></td>
                    <td><input type="radio" name="user_permission[<?php $user->id?>]" value="4" <?phpif ($user->rights == '4' || ($user['id'] == $user_id && $user['rights'] == ''): ?>checked="checked"<?php endif;?> /></td>
                </tr>
                <?php };?>       
            </tbody>
        </table>
