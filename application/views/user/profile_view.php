...
<div class="container">
    <div class="row">
        <div class="col-md-12" id="profileOverviewWrapper">
            <div class="col-md-3" itemscope itemtype="http://schema.org/Person">
                ...
                alt="<?php echo $userDetails->fullName ?>" data-toggle="tooltip" data-placement="auto" 
                title="<?php echo $userDetails->fullName  ?>">
			...
			<span class="vcard-username" itemprop="additionalName"><?php echo $userDetails->username  ?></span>
                ...
                <ul class="vcard-details">
                    <li class="vcard-detail" itemprop="homeLocation" title="Colorado Springs, CO">
                        <span class="octicon octicon-location"></span>Colorado Springs, CO</li>
                    <li class="vcard-detail">
                        ...
                        title="<?php echo $userDetails->since ?>">
                            <?php echo $userDetails->since?>
                        </time>
                    </li>
                </ul>
            </div>
            <?php echo form_open('', 'id="profileForm"') ?>
                ...
                <a role="button" class="btn btn-primary" id="modifyUser" href="user/modifyuser" 
                title="Update Profile Information"><i class="fa fa-edit"></i> Edit Profile</a>
                <?php echo form_close();?>
        </div>
    </div>
</div>
    ...
    $('a#modifyUser').on('click', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
            	$('div#profileOverviewWrapper').toggle();
                $('body').append(data);
