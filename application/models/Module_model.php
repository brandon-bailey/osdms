...
class Module_Model extends CI_Model
{
    ...
    public function archiveModule()
    {
        ...
        $cat = $this->category;
        $location = $this->location;
        fmove(ABSPATH . 'modules/custom/' . $cat . '/files/' . $location, ABSPATH .
         'modules/custom/' . $cat . '/archiveDir/' . $location);
    }
    ...
    public function unArchiveModule($status)
    {
        ...
        $cat = $this->category;
        $location = $this->location;
        fmove(ABSPATH . 'modules/custom/' . $cat . '/archiveDir/' . $location, ABSPATH .
            'modules/custom/' . $cat . '/files/' . $location);
    }
}
