	...
	*/
	...
	public function emailPeople($id) {
		...
		if (NULL !== $reviewerList) {
			$userList = $this->email_model->getEmailUserObj($reviewerList) ? $this->email_model->getEmailUserObj($reviewerList) : NULL;
		}

		if (NULL !== $userList) {
			$emailList = $this->email_model->getEmailList($userList) ? $this->email_model->getEmailList($userList) : NULL;
		}
