...
var Wodo = Wodo || (function () {
    ...
    window.dojoConfig = (function() {
        ...
        return {
            ...
            paths: {
				...
				"extras":     installationPath + "/extras"
            }
        };
    }());
    ...
    var /** @inner @type{!boolean} */
        ...
        defaultUserData = {
            fullName: "",
            color:    "black",
            imageUrl: "extras/avatar-joe.png"
        },
        /** @inner @const
            @type{!Array.<!string>} */
    ...
    function initTextEditor() {
        require([
            ...
            "webodf/editor/extras/FullWindowZoomHelper",
            "webodf/editor/extras/EditorSession",
            "webodf/editor/extras/Tools",
            "webodf/editor/extras/Translator"],
    ...
    function loadDojoAndStuff(callback) {
        ...
        link.rel = "stylesheet";
        link.href = installationPath + "/resources/app.css";
        link.type = "text/css";
        link.async = false;
