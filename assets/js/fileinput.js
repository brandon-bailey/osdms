(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            indicatorSuccess: '<i class="fa fa-file fa-2x text-success"></i>',
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    </div>\n' +
            '</div>',
        tIcon = '<span class="fa fa-file-o"></span>',
        ...
        tModal = '<div id="{id}" class="modal fade">\n' +
            ...
            '        <textarea class="form-control" style="font-family:Monaco,Consolas,monospace; height: {height}px;width:100%;" readonly>{body}</textarea>\n' +
            '      </div>\n' +
            '    </div>\n' +
            '  </div>\n' +
            '</div>',
        ...
        tAudio = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
            ...
            '   {footer}\n' +
            '</div>',
		 uAudio = '<div class="file-preview-frame{frameClass}" id="{previewId}" data-fileindex="{fileindex}"' +
            ' title="{caption}" ' + STYLE_SETTING + '>\n' +
			'       <input type="hidden" src="' + '{data}' + '" value="{type}">\n' +
            '   <button class="btn btn-primary">\n' +
			'<i class="fa fa-file-audio-o"></i> Convert to MP3?       \n'+
            '       ' + DEFAULT_PREVIEW + '\n' +
            '   </button>\n' +
            '   {footer}\n' +
            '</div>',	
        ...
        defaultPreviewTypes = ['image', 'html', 'text', 'video', 'audio', 'flash', 'object', 'uaudio'],
        defaultPreviewSettings = {
			...
			uaudio: {width: "213px", height: "80px"},
        ...
        defaultFileTypeSettings = {
            ...
            uaudio: function (vType, vName) {
                return (vType !== undefined && vType.match(/\.audio\/(wma|x-ms-wma)$/i)) || vName.match(/\.(wma|x-ms-wma)$/i);
            },				
    ...
    FileInput.prototype = {
        ...
        previewDefault: function (file, previewId, isDisabled) {
            ...
            if (isDisabled === true) {
                ...
                footer += '<div class="file-other-error text-danger"><i class="fa fa-exclamation-triangle"></i></div>';
            }
        ...
        renderUpload: function () {
            var self = this, css = self.uploadClass + ' hide', content = '', status = '';
            if (!self.showUpload) {
                return '';
            }
            if (self.isDisabled) {
