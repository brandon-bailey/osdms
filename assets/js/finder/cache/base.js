...
_.fixScrollRadius = function() {
    ...
    $('#toolbar a[href="kcact:about"]').click(function() {
        var html = '<div class="box about">' +
            '<div class="head"><a href="#" target="_blank">Finder</a> ' + _.version + '</div>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (_.version < data.version)
                        span.html('<a href="#" target="_blank">' + _.label("", {version: data.version}) + '</a>');
                    else
                        span.html(_.label("Finder is up to date!"));
                },
                error: function() {
                    if (!dlg.html().length)
                        return;
